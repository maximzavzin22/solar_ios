...
class AlarmDetailController: UIViewController, UINavigationControllerDelegate, UIScrollViewDelegate {
    ...
    func setupContentScrollView() {
        ...
        contentScrollView.addConstraintsWithFormat("H:[v0(\(360.dp))]", views: alarmContactView)
...
class AlarmContactView: UIView {
    ...
    func setupPersonView() {
        ...
        personView.addConstraintsWithFormat("H:|-\(20.dp)-[v0(\(130.dp))]-\(6.dp)-[v1]-\(20.dp)-|", views: personTitleLabel, personValueLabel)
