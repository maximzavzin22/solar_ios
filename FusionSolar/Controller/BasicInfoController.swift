...
class BasicInfoController: UIViewController, UINavigationControllerDelegate, UIScrollViewDelegate {
    ...
    func setupView() {
        ...
        self.view.addConstraintsWithFormat("H:[v0(\(390.dp))]", views: contentScrollView)
    ...
    func setupContentScrollView() {
        ...
        contentScrollView.addConstraintsWithFormat("H:[v0(\(390.dp))]", views: emptyBlockView)
        contentScrollView.addConstraintsWithFormat("H:[v0(\(390.dp))]", views: contentView)
