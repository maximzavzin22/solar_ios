...
class OverviewMenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let defoultImageName = ["overview_icon","statistics_icon","layout_icon","devices_icon"]
    let activeImageName = ["overview_icon_active","statistics_icon_active","layout_icon_active","devices_icon_active"]
    let titles = [NSLocalizedString("overview", comment: ""), NSLocalizedString("statistics", comment: ""), NSLocalizedString("layout", comment: ""), NSLocalizedString("devices", comment: "")]
