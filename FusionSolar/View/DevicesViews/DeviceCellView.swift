...
class DeviceCellView: UICollectionViewCell {
    ...
    var device: Device? {
        didSet {
            ...
            self.typeValueLabel.text = NSLocalizedString("dongle", comment: "")
        }
    }
    ...
    func setupTextsContentView() {
        ...
        textsContentView.addConstraintsWithFormat("V:|[v0]-\(8.dp)-[v1]-\(8.dp)-[v2]-\(8.dp)-[v3]", views: plantTitleLabel, snTitleLabel, typeTitleLabel, dateTitleLabel)
